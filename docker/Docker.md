...
* The creation of QC images is currently not supported when using Docker or Singularity due to rendering issues when a display is not (necessarily) present, hence the `--no-qc` argument.
